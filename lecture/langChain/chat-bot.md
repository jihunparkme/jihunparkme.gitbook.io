...
## HuggingFace 오픈소스를 활용한 RAG Pipeline 구성

[LGAI-EXAONE/EXAONE-3.0-7.8B-Instruct](https://huggingface.co/LGAI-EXAONE/EXAONE-3.0-7.8B-Instruct) 모델을 활용한 RAG Pipeline 구성

[google colab](https://colab.research.google.com/drive/17pRCJfmOAv0MX_aa9ft4zzCTAjT8jDQh?usp=sharing)

## PromptTemplate 활용

[source code](https://github.com/jihunparkme/study-ai/blob/main/5-etc/5_5_PromptTemplate_%ED%99%9C%EC%9A%A9.ipynb)
